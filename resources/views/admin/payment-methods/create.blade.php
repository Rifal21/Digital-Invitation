            ...
            <div class="bg-white rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.02)] border border-slate-50 overflow-hidden" data-aos="fade-up">
                <div class="p-12 md:p-16">
                    ...
                    <div class="mb-10 pb-6 border-b border-slate-50">
                        ...
                        <h4 class="text-3xl font-serif font-black text-[#4D243D]">Provider Baru</h4>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.payment-methods.store') }}" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <div class="space-y-3">
                            ...
                            <input type="text" name="name" placeholder="Nama provider..." class="w-full px-6 py-4 rounded-xl border border-slate-100 bg-slate-50 text-[11px] font-bold text-[#4D243D] focus:ring-2 focus:ring-[#EDD4B2] focus:border-[#EDD4B2] transition duration-300" required>
                        </div>

                        <div class="space-y-3">
                            <label class="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">Account Number (Opsional)</label>
                            <input type="text" name="account_number" placeholder="Nomor rekening..." class="w-full px-6 py-4 rounded-xl border border-slate-100 bg-slate-50 text-[11px] font-bold text-[#4D243D] focus:ring-2 focus:ring-[#EDD4B2] focus:border-[#EDD4B2] transition duration-300">
                        </div>

                        <div class="space-y-3">
                            <label class="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">Account Holder Name (Opsional)</label>
                            <input type="text" name="account_name" placeholder="Nama pemilik..." class="w-full px-6 py-4 rounded-xl border border-slate-100 bg-slate-50 text-[11px] font-bold text-[#4D243D] focus:ring-2 focus:ring-[#EDD4B2] focus:border-[#EDD4B2] transition duration-300">
                        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="relative group">
                                <label class="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-slate-100 rounded-2xl hover:bg-slate-50 transition cursor-pointer p-6 text-center">
                                    <i class="fas fa-qrcode text-3xl text-slate-200 mb-3 group-hover:text-[#4D243D]/30 transition"></i>
